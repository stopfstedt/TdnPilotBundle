...
namespace Tdn\PilotBundle\Tests\OutputEngine;
...
/**
 * Class TwigOutputEngineTest
 * @package Tdn\PilotBundle\Tests\Model
 */
class TwigOutputEngineTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var Filesystem
     */
    ...
    /**
     * @return TwigOutputEngine
     */
    protected function getOutputEngine()
    {
        $outputEngine = new TwigOutputEngine();
