...
use Tdn\PilotBundle\Services\Utils\Symfony\Routing\Dumper\Driver\XmlDumper;
...
class XmlDumperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testExport()
    {
        ...
        $this->assertEquals($dumper->dump(), file_get_contents($this->fixtureDirPath . '/routing.xml'));
    }
